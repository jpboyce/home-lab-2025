...
source "proxmox-iso" "windows2022" {
    ...
    vm_name = "windows2022-base"
    template_description = "Windows 2022 Base"

    # ISO Settings
    iso_file = "${var.win2022_iso_file}"                        # The path of the ISO file to boot from
    ...
    additional_iso_files {
        ...
        device = "sata4"
        cd_files = [
            "answer_files/2022/proxmox/autounattend.xml", # The path to the answer file to use for the installation
    ...
    # Other VM Settings
    os = "win11"            # The default is other, but we are setting this to win11 for Windows 2022
    machine = "q35"         # The default is pc, but we are setting this to q35 for Windows 2022?
...
# Build the Windows 2022 Base VM
build {
